...
public class armTesting extends LinearOpMode {
   ...
   public void runOpMode() {
     ...
     /* claw = hardwareMap.get(CRServo.class, "claw");
      ...
      leftSide.setDirection(Servo.Direction.REVERSE);
      rightSide.setDirection(Servo.Direction.FORWARD);
     ...
     /* claw.setPower(-.7);
      ...
      leftSide.setPosition(-0.1);
      rightSide.setPosition(-0.1);

      while(opModeIsActive()){
         flipper.setPosition(.91);
         sleep(1000);
         leftSide.setPosition(.91);
...
*/
   ...
   public void arm(String direction, int target) {
      if (direction.equals("UP")) {
         ...
         arm2.setTargetPosition(armRightPos);
